...
const PostGraduation2 = () => {
  ...
  return (
    <div>
      <Head>
        {/* Title */}
        <title>Advanced Machine Learning Course | TheCorrelation</title>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl lg:text-2xl text-gray-200 leading-relaxed max-w-2xl">
                ...
                Learning, CNNs, RNNs, LSTMs, Transformers, NLP, Ensemble Models,
                Dimensionality Reduction, Hyperparameter Tuning, and AI model
                optimization — powered by TensorFlow and PyTorch. Learn through
                projects, case studies, and industry-focused applications.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-lg text-gray-600 mb-6">
                The Advanced Machine Learning (AML) program is designed for
                learners who already understand ML basics and want to transition
                into industry-level machine learning expertise. This program
                focuses on building high-performing models, mastering advanced
                algorithms, optimizing workflows, and preparing for real-world
                ML challenges.
              </p>
